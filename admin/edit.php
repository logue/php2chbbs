...
<b><?php echo $file_name?></b>を編集しています　　　　　
<a class="item" href="edit.php?bbs=<?php echo $_REQUEST['bbs']?>">編集メニュー</a>　　　　　
<a class="item" href="edit.php?mode=view&amp;bbs=<?php echo $_REQUEST['bbs']?>" target="_blank">確認</a><br />
<br />
...
$header = str_replace("<GUIDE>",    '<form action="edit.php" method="post"><input type="hidden" name="bbs" value="'.$_REQUEST['bbs'].'" /><input type="hidden" name="file" value="head" /><input type="submit" value="head.txtを編集する" /></form>', $header);
$header = str_replace("<OPTION>",   '<form action="edit.php" method="post"><input type="hidden" name="bbs" value="'.$_REQUEST['bbs'].'" /><input type="hidden" name="file" value="option" /><input type="submit" value="option.txtを編集する" /></form>', $header);
$header = str_replace("<PUTAD>",    '<form action="edit.php" method="post"><input type="hidden" name="bbs" value="'.$_REQUEST['bbs'].'" /><input type="hidden" name="file" value="putad" />　　　　<input type="submit" value="putad.txtを編集する" /></form>', $header);
	...
	<tr>
		<td>
			<form action="edit.php" method="post">
				...
				<input type="submit" value="headad.txtを編集する" />
			</form>
		</td>
	</tr>
</table><br />
